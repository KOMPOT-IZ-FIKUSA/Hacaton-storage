...
class DialogRemoveItem(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label.setText(_translate("Dialog", "id товара:"))
    ...
    def on_confirm_button_release(self, event):
        try:
            ...
            self.error_text.setText(f'Ошибка ввода')
            return
        try:
            item = StorageItem.get_by_id(self.select_window_setup.category, id_)
        except:
            self.error_text.setText("Такого id не существует")
            return
        item.delete()
